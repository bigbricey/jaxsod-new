...
export const metadata: Metadata = {
  title: 'Contact Jax Sod | Free Sod Installation Quote Jacksonville FL',
  description:
    'Get a free sod installation quote in Jacksonville, FL. Call or text (904) 901-1457. Nearly 40 years of experience. Fast response!',
  alternates: { canonical: 'https://jaxsod.com/contact' },
}
              ...
              <div className="space-y-6 mb-10">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-secondary-700">Monday – Friday: 7:00 AM – 5:00 PM</p>
                    <p className="text-secondary-700">Saturday: 8:00 AM – 2:00 PM</p>
                    <p className="text-secondary-600 text-sm mt-1">
                      Closed Sunday
                    </p>
                  </div>
