...
**Zone 1 - High Water Use** (within 10 feet of house):
- Foundation plantings requiring regular irrigation
- High-impact areas for entertaining
- Plants requiring consistent moisture

**Zone 2 - Moderate Water Use** (10-25 feet from house):
- Mix of adapted and native plants
- Seasonal irrigation during establishment
- Balance of beauty and sustainability

**Zone 3 - Low Water Use** (beyond 25 feet):
- Primarily native and adapted plants
- Minimal irrigation after establishment
- Natural and informal designs

#### Efficient Irrigation Strategies

**Drip Irrigation**: Most efficient for shrub and tree zones
**Smart Controllers**: Weather-based irrigation adjustment
**Rain Sensors**: Prevent overwatering during rainy periods
**Mulching**: Retain moisture and reduce irrigation needs

## Florida-Friendly Plant Combinations

### Sunny Area Combinations

**Tropical Paradise Theme**:
- Canopy: Sabal Palm (Florida's state tree)
- Understory: Firebush, Wild Coffee, Simpson's Stopper
- Groundcover: Beach Sunflower, Coontie
- Accent: Bird of Paradise, Bougainvillea (where protected)

**Native Meadow Theme**:
- Canopy: Live Oak, Red Cedar
- Understory: Beauty Berry, Native Azaleas
- Perennials: Fakahatchee Grass, Wild Bergamot
- Seasonal: Blanket Flower, Black-Eyed Susan

**Coastal Style Theme**:
- Canopy: Cabbage Palm, Southern Red Cedar
- Understory: Yaupon Holly, Wax Myrtle
- Groundcover: Beach Sunflower, Seaside Goldenrod
- Accent: Spanish Bayonet, Prickly Pear Cactus

### Shaded Area Combinations

**Forest Understory Theme**:
- Canopy: Existing Live Oaks or Southern Magnolia
- Understory: Wild Coffee, Marlberry, Spicebush
- Groundcover: Coontie, Wild Ginger
- Accent: Coral Honeysuckle (vine), Cardinal Flower

**Formal Shade Garden**:
- Structure: Camellias, Azaleas
- Texture: Japanese Painted Fern, Cast Iron Plant
- Groundcover: Liriope, Asiatic Jasmine
- Seasonal: Caladiums, Impatiens

### Transition Zones

**Woodland Edge**:
- Trees: Red Bud, Chickasaw Plum
- Shrubs: Spicebush, Hearts-a-Bustin'
- Perennials: Coral Bean, Wild Columbine
- Grasses: River Oats, Sedges

## Curb Appeal Enhancement Ideas
...
- Symmetrical plantings flanking entrance
- Layered heights from house to lawn
- Mix of evergreen structure and seasonal color
- Clean, maintained appearance

**Example Traditional Planting**:
- Backdrop: Southern Magnolia or Live Oak
- Tall shrubs: Camellia, Azalea
- Medium shrubs: Dwarf Yaupon Holly, Nandina
- Low plants: Liriope, Hostas
- Seasonal color: Caladiums, Impatiens

**Contemporary Approach**:
- Asymmetrical, architectural plantings
- Bold foliage contrasts
- Geometric arrangements
- Modern materials integration

**Example Contemporary Planting**:
- Structure: Sabal Palm cluster
- Bold foliage: Bird of Paradise, Giant Bird of Paradise
- Textural contrast: Fakahatchee Grass, Coontie
- Groundcover: Decorative gravel with accent plants
...
**Linear Plantings**:
- Consistent plant choices for unity
- Appropriate scale for driveway width
- Low-maintenance selections
- Seasonal interest considerations

**Suggested Plants**:
- Dwarf Yaupon Holly (evergreen structure)
- Liriope (grass-like texture)
- Seasonal rotation: Caladiums, Marigolds, Pansies

#### Walkway Enhancements

**Pathway Plantings**:
- Plants that soften hard edges
- Fragrant plants for sensory experience
- Lighting integration opportunities
- Safety considerations (non-thorny, stable)

**Effective Combinations**:
- Sweet Viburnum (background fragrance)
- Gardenia (seasonal blooms and fragrance)
- Mondo Grass (neat edging)
- Seasonal herbs: Rosemary, Lavender

### Mailbox and Street-Side Appeal

#### Mailbox Gardens

**Design Considerations**:
- Visibility for postal service
- Heat tolerance for full-sun exposure
- Drought tolerance for minimal maintenance
- Attractive year-round appearance

**Successful Plant Choices**:
- Background: Wax Myrtle or Yaupon Holly
- Color: Firebush, Pentas
- Texture: Fakahatchee Grass
- Groundcover: Beach Sunflower

#### Property Borders

**Natural Screening**:
- Native trees and shrubs for privacy
...
#### Material Choices for Jacksonville Climate

**Natural Stone**:
- Excellent heat tolerance
- Non-slip surfaces when sealed
- Durable in hurricane conditions
- Attractive aging characteristics
...
- Plants that connect indoor and outdoor spaces
- Consistent color palettes
- Functional plant choices (privacy, wind protection)
...
**Mosquito Control**: Moving water features reduce breeding sites
**Maintenance Access**: Design for easy cleaning and maintenance
**Power Requirements**: Consider electrical access and safety
**Wildlife Benefits**: Attract birds and beneficial insects

#### Suitable Water Features for Jacksonville

**Fountains**: Self-contained, easy maintenance
**Rain Gardens**: Functional stormwater management
**Reflection Pools**: Modern, architectural appeal
**Natural Ponds**: Wildlife habitat, naturalistic appeal
...
- Tree uplighting for dramatic effect
- Feature plant highlighting
- Architectural element enhancement
- Seasonal decoration integration

## Seasonal Interest and Color

### Spring Appeal (March-May)

**Flowering Trees**:
- Red Bud: Early pink blooms
- Dogwood: White or pink flowers
- Wild Cherry: Fragrant white clusters

**Shrub Color**:
- Azaleas: Peak blooming period
- Camellias: Late season varieties
- Spirea: Delicate white or pink flowers

**Annual Color**:
- Petunias: Cool-season performance
- Snapdragons: Tall spikes of color
- Sweet Alyssum: Fragrant carpet

### Summer Impact (June-August)

**Heat-Tolerant Bloomers**:
- Firebush: Continuous orange flowers
- Pentas: Clusters of colorful blooms
- Ixora: Tropical appearance

**Foliage Interest**:
- Caladiums: Colorful heart-shaped leaves
- Coleus: Dramatic foliage colors
- Persian Shield: Purple and silver leaves

**Container Gardens**:
- Heat-tolerant annual combinations
...
**Autumn Color**:
- Bald Cypress: Golden fall needles
- Red Maple: Brilliant red leaves
- Beautyberry: Purple berry clusters

**Late Season Blooms**:
- Asters: Purple fall flowers
- Goldenrod: Yellow autumn display
- Firecracker Plant: Red tubular flowers

**Winter Preparation**:
- Seed head interest
- Evergreen structure emphasis
- Holiday decoration opportunities

### Winter Interest (December-February)

**Evergreen Structure**:
- Southern Magnolia: Glossy green leaves
- Live Oak: Architectural branching
- Holly varieties: Berries and foliage

**Winter Blooms**:
- Camellias: Peak blooming season
- Flowering Quince: Early spring preview
- Winter Jasmine: Yellow flowers

## Integrating Lawn Areas with Landscape Design
...
**Natural Edges**:
- Curved lines that flow with natural contours
- Gradual transitions from lawn to plantings
- Integration with existing trees and features

**Formal Edges**:
- Clean, geometric lines
- Architectural integration with home style
- Symmetrical or balanced compositions

#### Plant Selection for Borders

**Transition Plants**:
- Medium-height plants that bridge lawn and taller plantings
- Plants that can handle some foot traffic
- Varieties that maintain neat, attractive edges

**Effective Border Plants**:
- Dwarf Yaupon Holly: Neat, evergreen structure
- Liriope: Grass-like texture, purple flowers
- Asiatic Jasmine: Spreading groundcover
- Dwarf Azaleas: Seasonal color, compact form

### Lawn Replacement Strategies

For areas where traditional lawn struggles:

#### Shade Solutions

**Deep Shade Areas**:
- Coontie groundcover plantings
- Fern gardens with pathway access
- Mulched areas with shade-tolerant plants
...
- Ornamental grasses that tolerate wet conditions

**High Traffic**:
- Hardscape pathways
- Durable groundcover alternatives
- Strategic placement of stepping stones
...
- Problem-solving for difficult sites
...
**Quality Materials**:
- Invest in good soil preparation
